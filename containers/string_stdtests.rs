...
// TODO(blukai): unsied to string? what?
//
// #[test]
...
fn test_from_utf8() {
    ...
    assert_eq!(String::from_utf8(xs).unwrap(), String::from_str("hello"));
    ...
    assert_eq!(err.into_bytes(), Vec::from_slice(b"hello\xff"));
...
// NOTE(blukai): this does not test string, does it?
//
// #[test]
// fn test_vectors() {
...
fn test_try_reserve() {
...

    {
        ...
        assert_matches!(
            empty_string.try_reserve(MAX_CAP + 1),
        ...
        assert_matches!(
            empty_string.try_reserve(MAX_USIZE),
            Err(CapacityOverflow),
...

    {
        ...
        let mut ten_bytes: String = String::from_str("0123456789");
...
fn test_try_reserve_exact() {
...

    {
        ...
        assert_matches!(
            empty_string.try_reserve_exact(MAX_CAP + 1),
            Err(CapacityOverflow),
            "isize::MAX + 1 should trigger an overflow!"
        );

        assert_matches!(
            empty_string.try_reserve_exact(MAX_USIZE),
            Err(CapacityOverflow),
            "usize::MAX should trigger an overflow!"
        );
    }
...
// NOTE(blukai): these are stupid, no?
//
// #[test]
// fn test_from_char() {
