//! NOTE: this is copypasta from `/rust/library/alloc/src/alloc.rs`.
...
use crate::{AllocError, Allocator, layout_dangling};
...
impl Global {
    ...
    fn alloc_impl(&self, layout: Layout, zeroed: bool) -> Result<NonNull<[u8]>, AllocError> {
        match layout.size() {
            0 => Ok(NonNull::slice_from_raw_parts(layout_dangling(&layout), 0)),
    ...
    unsafe fn grow_impl(
        ...
        match old_layout.size() {
            ...
            old_size => unsafe {
                ...
                ptr::copy_nonoverlapping(ptr.as_ptr(), new_ptr.as_ptr().cast(), old_size);
    ...
    unsafe fn shrink(
        ...
        match new_layout.size() {
            ...
            new_size => unsafe {
                ...
                ptr::copy_nonoverlapping(ptr.as_ptr(), new_ptr.as_ptr().cast(), new_size);
                self.deallocate(ptr, old_layout);
                Ok(new_ptr)
            },
        }
