// NOTE(blukai): this is copypasted from /rust/library/alloctests/tests/vec.rs
//
//   some things that are private/unstable are re-implemented / copypasted in:
//     - assert_matches
//     - struct_with_counted_drop
//
//   tests that test functionality that i don't have a need for are commented out.
//   usually there would be a comment in form of `SOMETHING(blukai): description`.
//   some repetitive ones may have @Something, for example @ExtendFromIterator to make it easier to
//   find stuff.
//
//   also note that vec! macro is implemented here. i do not wish to provide it.
//   but it's easier/nicer to have a local version of it in this file to not have to change std
//   tests much.

// NOTE(blukai): a bunch of imports are removed and changed.
use crate::vec::ReserveError::*;
use crate::vec::Vec;
...
// TODO(blukai): impl @ExtendFromIterator.
//
// #[test]
// fn test_extend() {
//     let mut v = Vec::new();
...
// UNIMPLEMENETED(blukai): @Clone and @Drain.
//
// #[test]
// fn test_retain() {
...
// UNIMPLEMENETED(blukai): @Partition.
//
// #[test]
// fn test_partition() {
...
// UNIMPLEMENETED(blukai): @Zip, @Unzip.
//
// #[test]
// fn test_zip_unzip() {
...
// UNIMPLEMENETED(blukai): @SwapRemove.
//
// #[test]
// #[should_panic]
...
// UNIMPLEMENETED(blukai): @IntoIter.
//
// #[test]
// fn test_move_items() {
//     let vec = vec![1, 2, 3];
...
// UNSTABLE(blukai): Drain::keep_rest is unstable.
//
// #[test]
...
// UNIMPLEMENTED(blukai): @IntoBoxedSlice.
//
// #[test]
...
// UNSTABLE(blukai): InPlaceIterable is unstable.
//
// #[test]
...
// UNIMPLEMENETED(blukai): @From: Cow.
//
// #[test]
// fn test_from_cow() {
//     let borrowed: &[_] = &["borrowed", "(slice)"];
...
// UNIMPLEMENETED(bluaki): @IntoIter.
//
// #[test]
// fn from_into_inner() {
//     let vec = vec![1, 2, 3];
...
// NOTE(blukai): removed .map_err that was extracting TryReserveErrorKind out of TryReserveError.
//   because i don't do that, i just have ReserveError.
#[test]
#[cfg_attr(miri, ignore)] // Miri does not support signalling OOM
fn test_try_reserve() {
...
fn test_try_reserve_exact() {
...

    {
        ...
        assert_matches!(
            ten_bytes.try_reserve_exact(MAX_USIZE),
            Err(CapacityOverflow),
            "usize::MAX should trigger an overflow!"
        );
    }

    {
        ...
        assert_matches!(
            ten_u32s.try_reserve_exact(MAX_USIZE - 20),
            Err(CapacityOverflow),
            "usize::MAX should trigger an overflow!"
        );
    }
...
// UNIMPLEMENTED(blukai): @Insert, @Remove, @SwapRemove, @Append, @Extend, @Drain, @Splice.
//
// #[test]
...
// UNSTABLE(blukai): following two tests can't run
//   std::vec::Vec works fine.
//   custom Drop impl seems to be the cause, std::vec::Vec has #[may_dangle], see
...
// UNIMPLEMENETED(blukai): @ExtendFromWithin.
//
// #[test]
...
// UNIMPLEMENTED(blukai): @ExtendFromWithin.
//
...
// UNIMPLEMENTED(blukai): @IntoFlattened.
//
// #[test]
...
// NOTE(blukai): changed from Vec::from to Vec::from_slice.
#[test]
fn test_vec_from_array_ref() {
    assert_eq!(Vec::from_slice(&[1, 2, 3]), vec![1, 2, 3]);
}

// NOTE(blukai): changed from Vec::from to Vec::from_slice.
#[test]
fn test_vec_from_array_mut_ref() {
    assert_eq!(Vec::from_slice(&mut [1, 2, 3]), vec![1, 2, 3]);
}

// UNIMPLEMENETED(blukai): @PopIf.
//
// #[test]
// fn test_pop_if() {
...
// UNIMPLEMENTED(blukai): @SwapRemove.
//
// #[test]
// #[should_panic]
// fn max_swap_remove() {
